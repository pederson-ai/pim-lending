        ...
        <CardContent>
          <table className="text-sm">
            <thead className="border-b border-slate-200 text-left text-slate-500">
              <tr><th className="py-3 pr-4">Borrower</th><th className="py-3 pr-4">Loan Number</th><th className="py-3 pr-4">Amount Due</th><th className="py-3 pr-4">Latest Statement</th><th className="py-3 pr-4">Email</th><th className="py-3 pr-4">Actions</th></tr>
            </thead>
            <tbody>
              {loans.map((loan) => {
